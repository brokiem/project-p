    ...
    <div class="container-lg flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
        ...
        <ul class="flex flex-col pb-4 md:p-4 mt-3 rounded-md md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <NuxtLink to="/" class="no-underline select-none block py-2 pl-3 pr-4 bg-gray-100 rounded md:bg-transparent md:hover:text-blue-700 text-gray-700 md:p-0 dark:text-white" aria-current="page">
              Beranda
            </NuxtLink>
          </li>
          <li>
            <div data-dropdown-toggle="profile-dropdown" class="cursor-pointer select-none block py-2 pl-3 pr-4 bg-gray-100 md:bg-transparent text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              ...
              <div id="profile-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow border dark:bg-gray-700">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                  <li>
                    <NuxtLink to="/profil/sejarah" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sejarah Sekolah</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/profil/visi-misi" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Visi &amp; Misi</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/profil/fasilitas" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Fasilitas Sekolah</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/profil/logo" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Logo Sekolah</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/profil/struktur-organisasi" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Struktur Organisasi</NuxtLink>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <li>
            <div data-dropdown-toggle="artikel-dropdown" class="cursor-pointer select-none block py-2 pl-3 pr-4 bg-gray-100 md:bg-transparent text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              ...
              <div id="artikel-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow border dark:bg-gray-700">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                  <li>
                    <NuxtLink to="/artikel/pengumuman" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pengumuman</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink to="/artikel/berita" class="no-underline text-gray-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Berita</NuxtLink>
                  </li>
                </ul>
              </div>
            </div>
