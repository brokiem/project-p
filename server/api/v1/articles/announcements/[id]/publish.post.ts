...
export default defineEventHandler(async (event) => {
    try {
        ...
        // Remove IS_DRAFT from existing article
        let flags = existingAnnouncement.flags & ~ArticleFlags.IS_DRAFT;
        // Add IS_PUBLISHED to existing article
        ...
        return errorResponse("Failed to publish announcement");
    }
});
